-- Q27: Transaction Control (TCL) — Safe Payment Processing
-- Task: Create a procedure ProcessMemberPayment that safely processes a payment using transaction control.
DELIMITER $$
